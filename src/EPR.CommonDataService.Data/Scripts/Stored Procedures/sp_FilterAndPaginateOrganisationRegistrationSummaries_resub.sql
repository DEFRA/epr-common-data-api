IF EXISTS (SELECT 1
           FROM sys.procedures
           WHERE object_id = OBJECT_ID(N'[dbo].[sp_FilterAndPaginateOrganisationRegistrationSummaries_resub]'))
    DROP PROCEDURE [dbo].[sp_FilterAndPaginateOrganisationRegistrationSummaries_resub];
GO

CREATE PROC [dbo].[sp_FilterAndPaginateOrganisationRegistrationSummaries_resub] @OrganisationNameCommaSeparated [nvarchar](255),
