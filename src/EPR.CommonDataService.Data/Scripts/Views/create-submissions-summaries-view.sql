...
IF EXISTS (SELECT 1 FROM sys.views WHERE object_id = OBJECT_ID(N'[apps].[v_SubmissionsSummaries_TstPom]'))
DROP VIEW [apps].[v_SubmissionsSummaries_TstPom];
GO

CREATE VIEW [apps].[v_SubmissionsSummaries_TstPom] AS WITH 
