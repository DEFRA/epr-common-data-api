...
public class RegistrationFeeCalculationDetailsControllerTests
{
    ...
    public async Task GetRegistrationFeeCalculationDetails_ValidRequest_WithResult_ReturnsOk()
    {
        ...
        var expectedResult = new[] { new RegistrationFeeCalculationDetails { OrganisationSize = "Large", NumberOfSubsidiaries = 10, NumberOfSubsidiariesBeingOnlineMarketPlace = 20 } }; // Mock result
