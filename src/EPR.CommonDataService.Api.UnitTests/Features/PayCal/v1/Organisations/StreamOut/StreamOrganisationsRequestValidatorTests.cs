...
namespace EPR.CommonDataService.Api.UnitTests.Features.PayCal.v1.Organisations.StreamOut;
...
public class StreamOrganisationsRequestValidatorTests
{
    ...
    {
        // Arrange
        var request = new StreamOrganisationsRequest { RelativeYear = year, CutOffDate = null };
    ...
    {
        // Arrange
        var request = new StreamOrganisationsRequest { RelativeYear = 10000, CutOffDate = null };
